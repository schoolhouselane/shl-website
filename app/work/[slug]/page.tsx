...
export async function generateMetadata({
  ...
  return {
    title,
    description,
    alternates: { canonical: `https://schoolhouselane.ai/work/${slug}` },
    openGraph: {
      title,
      description,
      url: `https://schoolhouselane.ai/work/${slug}`,
      type: 'article',
...
export default async function CaseStudyPage({
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: 'Home',
        item: 'https://schoolhouselane.ai',
      },
      {
        '@type': 'ListItem',
        position: 2,
        name: 'Work',
        item: 'https://schoolhouselane.ai/work',
      },
      {
        '@type': 'ListItem',
        position: 3,
        name: project.title,
        item: `https://schoolhouselane.ai/work/${slug}`,
      },
    ],
  }
  ...
  const caseStudySchema = {
    ...
    author: { '@id': 'https://schoolhouselane.ai/#organization' },
    provider: { '@id': 'https://schoolhouselane.ai/#organization' },
