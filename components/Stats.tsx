    ...
    <section className="bg-white px-5 md:px-[90px] pt-[40px] pb-[60px]">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 md:gap-0">
        ...
        <div className="flex flex-col gap-[2px] w-full md:w-[166px] shrink-0">
          {stats.map((s) => (
            <div key={s.label} className="border-b border-[#1e1e20]/50 py-[4.5px] flex flex-col gap-[4.5px]">
              <p className="font-semibold text-[36px] sm:text-[48px] md:text-[57px] leading-none text-[#1e1e20] uppercase">{s.value}</p>
        ...
        <div className="flex flex-col gap-[19px] max-w-full md:w-[446px] shrink-0">
          <h3 className="font-black text-[32px] sm:text-[40px] md:text-[60px] leading-[0.92] tracking-[-1.5px] uppercase text-[#1e1e20]">
        ...
        <div className="shrink-0">
          <Link
            href="/contact"
            className="btn-cta inline-flex items-center gap-3 border border-[#1e1e20] bg-white rounded-full px-[20px] md:px-[24px] py-[14px] md:py-[20px] text-[15px] md:text-[24px] font-medium uppercase text-[#1e1e20] transition-colors"
          >
            Let&apos;s talk
