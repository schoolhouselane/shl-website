...
export default function PricingHero() {
  return (
    <section className="bg-[#f5f3ef] px-4 md:px-6 lg:px-[90px] pt-[64px] md:pt-[95px] lg:pt-[82px]">
      {/* Image wrapper — inset by the same px as every other section */}
      <div className="relative overflow-hidden h-[536px] md:h-[545px] lg:h-[calc(100vh-82px)] flex items-end pb-[60px] md:pb-[80px] lg:pb-[120px]">
        <Image
