...
const team = [
  { src: '/images/people-1.png', name: 'Sarah Mitchell', role: 'Creative Director.', quote: 'A pioneer in aligning profit with purpose to capture hearts, minds, and market share.', email: 'sarah@schoolhouselane.co' },
  { src: '/images/people-2.png', name: 'James Okafor', role: 'Brand Strategist.', quote: 'Building brands that outlast trends and earn genuine loyalty from the right audiences.', email: 'james@schoolhouselane.co' },
  { src: '/images/people-3.png', name: 'Elena Vasquez', role: 'Art Director.', quote: 'Visual storytelling that cuts through noise and speaks directly to what people value.', email: 'elena@schoolhouselane.co' },
  { src: '/images/people-4.png', name: 'Tom Brennan', role: 'Campaign Lead.', quote: 'Every campaign is a conversation — we make sure it is one worth having.', email: 'tom@schoolhouselane.co' },
]

const teamRight = [
  { src: '/images/people-6.png', name: 'Priya Nair', role: 'Digital Designer.', quote: 'Design is not decoration — it is the first argument your brand makes.', email: 'priya@schoolhouselane.co' },
  { src: '/images/people-7.png', name: 'Lucas Ferreira', role: 'Motion Designer.', quote: 'Movement gives ideas a heartbeat. That is what we design for.', email: 'lucas@schoolhouselane.co' },
  { src: '/images/people-8.png', name: 'Anna Kowalski', role: 'Content Strategist.', quote: 'Words are the architecture of trust. We build every sentence with intention.', email: 'anna@schoolhouselane.co' },
  { src: '/images/people-9.png', name: 'Marcus Chen', role: 'UX Designer.', quote: 'Good experience design is invisible — great experience design is unforgettable.', email: 'marcus@schoolhouselane.co' },
]
...
export default function AboutTeam() {
  ...
  return (
    <section id="team" className="bg-[#f5f3ef] py-[80px] md:py-[120px] flex flex-col gap-[40px]">

      {/* Header */}
      <div className="px-5 md:px-[90px] flex flex-col md:flex-row md:items-end md:justify-between gap-4">
        <div className="flex flex-col gap-[10px]">
          <h2 className="font-black text-[36px] md:text-[64px] leading-[0.9] tracking-[-1.28px] uppercase text-[#1e1e20]">
        ...
        <Link
          href="/jobs"
          className="btn-cta inline-flex items-center gap-3 w-fit border border-[#1e1e20] rounded-full px-[24px] py-[12px] text-[16px] font-medium uppercase text-[#1e1e20] shrink-0"
        >
          See Open Roles
        ...
        <div ref={scrollRef} className="flex gap-px overflow-x-auto scrollbar-hide">
          ...
          {team.map((member, i) => (
            <div key={i} className="group flex shrink-0">
              <div className="relative w-[140px] md:w-[200px] h-[300px] md:h-[762px] overflow-hidden">
                <Image src={member.src} alt={member.name} fill className="object-cover object-top transition-transform duration-500 group-hover:scale-105" sizes="200px" />
              </div>
          ...
          <div className="flex shrink-0 h-[300px] md:h-[762px]">
            <div className="relative w-[140px] md:w-[200px] h-full overflow-hidden bg-[#313131]">
              <Image src="/images/people-5.png" alt="Darren McGrath" fill className="object-cover object-top" sizes="200px" />
            </div>
            <div className="w-[160px] md:w-[347px] h-full bg-white flex flex-col justify-between px-[16px] md:px-[40px] py-[20px] md:py-[60px]">
              ...
              <div className="flex flex-col gap-[14px] md:gap-[18px]">
                <p className="text-[13px] md:text-[16px] text-[#111] leading-[1.7]">
                  A pioneer in aligning profit with purpose — Darren founded SHL to prove that the most commercially effective brands are also the most human ones.
                </p>
                <p className="text-[13px] md:text-[16px] text-[#111] font-semibold italic leading-snug">
                  &ldquo;A pioneer in aligning profit with purpose to capture hearts, minds, and market share.&rdquo;
                </p>
                <p className="text-[13px] md:text-[16px] text-[#111] italic">dmg@schoolhouselane.co</p>
              </div>
            </div>
          </div>
      ...
      <div className="px-5 md:px-[90px]">
        <div className="w-full h-[2px] bg-[#1e1e20]/10 rounded-full overflow-hidden">
          <div className="h-full bg-[#1e1e20] rounded-full transition-all duration-150" style={{ width: `${Math.max(6, progress * 100)}%` }} />
        </div>
      </div>
