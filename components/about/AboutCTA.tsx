  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[12px] items-start lg:items-end lg:w-[245px] shrink-0">
        <CalendlyButton className="btn-cta flex items-center gap-3 bg-white rounded-full px-[18px] md:px-[20px] lg:px-[24px] py-[10px] md:py-[11px] lg:py-[12px] text-[16px] font-medium uppercase whitespace-nowrap text-[#1e1e20] w-fit">
          Book a Demo
