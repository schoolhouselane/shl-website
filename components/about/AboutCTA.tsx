  ...
  return (
    <section className="bg-[#d7d7d7] px-5 md:px-[90px] py-[60px] flex flex-col lg:flex-row lg:items-end lg:justify-between gap-10">
      ...
      <div className="flex flex-col gap-[19px] max-w-full lg:max-w-[446px]">
        <h2 className="font-black text-[40px] md:text-[60px] leading-[0.92] tracking-[-1.5px] uppercase text-[#1e1e20]">
      ...
      <div className="flex flex-col gap-[12px] items-start lg:items-end lg:w-[245px] shrink-0">
        <Link
          href="/contact"
          className="btn-cta flex items-center gap-3 bg-white rounded-full px-[24px] py-[20px] text-[18px] md:text-[24px] font-medium uppercase text-[#1e1e20] w-fit"
        >
          Book a Call
