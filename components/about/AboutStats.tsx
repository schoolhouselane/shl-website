    ...
    >
      <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-10 md:gap-[40px] lg:gap-[60px]">
        ...
        >
          ...
          <CalendlyButton className="btn-cta inline-flex items-center justify-center gap-3 w-fit bg-white border border-[#1e1e20] rounded-full px-[12px] py-[8px] md:px-6 md:py-3 lg:px-[24px] lg:py-[12px] text-[16px] font-medium uppercase whitespace-nowrap text-[#1e1e20]">
            Book a Demo
