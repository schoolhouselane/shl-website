  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-3 w-fit border border-white rounded-full px-6 py-3 text-[16px] font-medium uppercase text-white hover:bg-white hover:text-[#1e1e20] transition-colors font-manrope"
      >
        Get Growth
