  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[6px] items-stretch shrink-0 w-[120px] md:w-[183px] lg:w-[245px]">
        <CalendlyButton className="btn-cta bg-white flex items-center justify-center gap-[6px] md:gap-[12px] px-[12px] md:px-[24px] py-[10px] md:py-[12px] rounded-[50px] whitespace-nowrap w-full border border-white">
          <span className="font-medium text-[#1e1e20] text-[12px] md:text-[16px] uppercase leading-normal whitespace-nowrap">
            Book a Demo
          </span>
