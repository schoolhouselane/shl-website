...
export default function WorkGallery() {
  return (
    <section className="bg-[#f5f3ef] py-[60px] md:py-[120px] px-5 md:px-[90px]">
      <div className="flex gap-[12px] md:gap-[12px] items-stretch w-full overflow-hidden">

        {/* Col 1 — tall single image */}
        <div className="relative flex-[2] min-h-[300px] md:min-h-[420px] overflow-hidden">
          <Image
        ...
        <div className="flex flex-col gap-[12px] flex-[2]">
          ...
          <div className="relative overflow-hidden min-h-[120px] md:min-h-[160px]">
            <Image
